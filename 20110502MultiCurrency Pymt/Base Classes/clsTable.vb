...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OWHS" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "OWTR") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            AddTables("DABT_PayTemp", "Multicurrency Payment Temp", SAPbobsCOM.BoUTBTableType.bott_NoObject)
            AddFields("DABT_PayTemp", "CardCode", "CardCode", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("DABT_PayTemp", "DocEntry", "DocEntry", SAPbobsCOM.BoFieldTypes.db_Numeric, , 10)
            AddFields("DABT_PayTemp", "DocNum", "Document Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            AddFields("DABT_PayTemp", "Currency", "Currency", SAPbobsCOM.BoFieldTypes.db_Alpha, , 3)
            AddFields("DABT_PayTemp", "AppAmt", "Applied Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            ' AddFields("DABT_PayTemp", "AmtFC", "Applied Amount (FC)", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("DABT_PayTemp", "PymntNo", "Incoming Payment Number", SAPbobsCOM.BoFieldTypes.db_Numeric, , 10)
            AddFields("DABT_PayTemp", "Balance", "Balance", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("DABT_PayTemp", "BalFC", "Balance Amount (FC)", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
